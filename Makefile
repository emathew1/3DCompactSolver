...
3DCompact.o: 3DCompact.cpp Macros.hpp Utils.hpp BC.hpp TimeStepping.hpp CSolver.hpp CSolver_AWS.hpp 
	$(CC) $(CFLAGS) -c $< 
...
CSolver_AWS.o: CSolver_AWS.cpp CSolver_AWS.hpp Macros.hpp Utils.hpp BC.hpp TimeStepping.hpp IdealGas.hpp SpongeBC.hpp Derivatives.hpp Filter.hpp
	$(CC) $(CFLAGS) -c $<
